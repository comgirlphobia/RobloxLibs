...
local SatOverlay = Utility.AddDrawing("Image", {
    Size = InternalBase.Size,
    Position = InternalBase.Position,
    Data = Library.Theme.WhiteGradient, -- you can generate one, or build as stack of squares
    Transparency = 1,
    Visible = false,
    ZIndex = 4
})
local ValOverlay = Utility.AddDrawing("Image", {
    Size = InternalBase.Size,
    Position = InternalBase.Position,
    Data = Library.Theme.BlackGradient,
    Transparency = 1,
    Visible = false,
    ZIndex = 5
})
table.insert(Tab["Render"], SatOverlay)
table.insert(Tab["Render"], ValOverlay)
                        ...
                        --
-- Replace InternalHue (the missing bar) with this:
local HueLines = {}
for y = 0, 187 do
    local frac = y / 187
    local line = Utility.AddDrawing("Square", {
    ...
    table.insert(HueLines, line)
    table.insert(Tab["Render"], line)
end
